...
// Auth-only app
const authConfig = {
  apiKey: `${process.env.REACT_APP_CUSTOM_FIREBASE_API_KEY}`,
  authDomain: `${process.env.REACT_APP_CUSTOM_FIREBASE_AUTH_DOMAIN}`,
  projectId: `${process.env.REACT_APP_CUSTOM_FIREBASE_PROJECT_ID}`,
  appId: `${process.env.REACT_APP_CUSTOM_FIREBASE_APP_ID}`,
  storageBucket: `${process.env.REACT_APP_CUSTOM_STORAGE_BUCKET}`,
  messagingSenderId: `${process.env.REACT_APP_CUSTOM_MESSAGING_SENDER_ID}`,
  measurementId: `${process.env.REACT_APP_CUSTOM_MEASUREMENT_ID}`,
};
